...
| APIs/operations/products/subscriptions/named values/backends | partial | P0-P1 | Core lifecycles and four-SDK secret rotation; Go SDK revision cloning, release promotion, version-set, named-value, and lossless backend CRUD/reconnect; policy-substituted and backend-ID gateway workflows; backend credential transport, Key Vault retrieval, and broader resources pending |
