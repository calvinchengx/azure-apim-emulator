...
- APIs, revisions, releases, versions, operations, schemas, tags, products,
  ...
  APIs, operations, products, groups, API version sets, and tags now have canonical lossless documents and recursive PATCH semantics; the same persistence pattern remains to be extended across other core resources.
