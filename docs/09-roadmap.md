...
- APIs, revisions, releases, versions, operations, schemas, tags, products,
  ...
  APIs, operations, and products now have canonical lossless documents and recursive PATCH semantics; the same persistence pattern remains to be extended across other core resources.
