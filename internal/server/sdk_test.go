...
func TestGoManagementSDKConfiguresProtectedGateway(t *testing.T) {
	...
	// Every Microsoft SDK client the witnesses use, built once. Each subtest
	// below is the named witness for one resource family's parity claim.
	var err error
	...
	var (
		certificateID, versionSetID, loggerID, sourceAPIID, schemaContentType string
		displayName, path, method, template, operationDescription             string
		primary, secondary, scope, rotatedPrimary                             string
		required                                                              bool
		state                                                                 armapimanagement.SubscriptionState
		verbosity                                                             armapimanagement.Verbosity
	...
	t.Run("api-version-set", func(t *testing.T) {
	...
	t.Run("api-revision", func(t *testing.T) {
	...
	t.Run("openapi-import-and-export", func(t *testing.T) {
	...
	t.Run("product-group", func(t *testing.T) {
	...
	t.Run("group-user", func(t *testing.T) {
	...
	t.Run("api-schema", func(t *testing.T) {
	...
	t.Run("diagnostic", func(t *testing.T) {
		alwaysLog := armapimanagement.AlwaysLogAllErrors
		verbosity = armapimanagement.VerbosityInformation
	...
	t.Run("api-diagnostic", func(t *testing.T) {
	...
	t.Run("api-policy", func(t *testing.T) {
	...
	t.Run("api-revision-clone", func(t *testing.T) {
	...
	t.Run("api-release", func(t *testing.T) {
	...
	t.Run("subscription", func(t *testing.T) {
		...
		subscriptionName := "Go SDK subscription"
		primary, secondary = "go-sdk-key", "go-sdk-secondary"
		...
		rotatedPrimary = *rotated.PrimaryKey
	})
	...
	t.Run("api-release-update", func(t *testing.T) {
	...
	t.Run("logger-reference-protection", func(t *testing.T) {
