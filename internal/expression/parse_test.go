...
func TestEvalLiteralsOperatorsAndGrouping(t *testing.T) {
	cases := []struct {
		...
		{"@{ if (true) { return 1; } else { return 2; } }", int64(1)},
		{"@{ if (false) { return 1; } else { return 2; } }", int64(2)},
		{"@{ var x = 1; if (x == 1) { var y = x + 1; return y; } else { return 0; } }", int64(2)},
		{"@{ if (true) { if (false) { return 1; } else { return 2; } } else { return 3; } }", int64(2)},
	}
...
func TestEvalAndParseErrors(t *testing.T) {
	for _, source := range []string{
		...
		"@{ if (true) return 1; else { return 2; } }",
		"@{ if (true) { return 1; } else return 2; }",
		"@{ if (true) { return 1; } else { return 2; } extra }",
		"@{ if (1 + ) { return 1; } else { return 2; } }",
		"@{ if (1 / 0) { return 1; } else { return 2; } }",
		"@{ if (true) { return 1; extra } else { return 2; } }",
		"@{ if (1) { return 1; } else { return 2; } }",
